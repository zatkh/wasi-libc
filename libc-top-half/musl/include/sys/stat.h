...
#if defined(__vwasm) || defined(__wasilibc_unmodified_upstream) /* WASI has no chmod */
int chmod(const char *, mode_t);
int fchmod(int, mode_t);
int fchmodat(int, const char *, mode_t, int);
#endif
#if defined(__vwasm) || defined(__wasilibc_unmodified_upstream) /* WASI has no umask */
mode_t umask(mode_t);
#endif
